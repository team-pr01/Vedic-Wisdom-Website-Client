    ...
    return (
      <div className="flex flex-col gap-2 font-Nunito w-full">
        ...
        <input
          ...
          ref={ref}
          disabled={isDisabled}
          className={`w-full px-4 py-[14px] rounded-lg  border leading-[18px] focus:outline-none focus:border-primary-10 transition duration-300 placeholder:text-sm ${isDisabled ? "cursor-not-allowed bg-neutral-50/20" : "bg-white"} ${
