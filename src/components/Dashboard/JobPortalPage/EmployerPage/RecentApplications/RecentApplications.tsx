...
const RecentApplications: React.FC<RecentApplicationsProps> = ({ applications }) => {
  ...
  return (
    <div className="bg-white border border-neutral-20 rounded-2xl p-6">
      <h3 className="text-lg font-bold text-neutral-90 mb-4">Recent Applications</h3>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-semibold text-neutral-90 text-sm">{app.name}</h4>
                ...
                <button className="mt-2 text-xs text-primary-10 hover:underline font-medium">
                  View Application →
                </button>
              </div>
            </div>
